...
#define SUNXI_DISPLAY_FRAME_BUFFER_ADDR    SDRAM_OFFSET(0x02020000)
...
#ifdef CONFIG_SUN8IW16P1_NOR
#define CONFIG_TARGET_NAME      spinor-sun8iw16p1
#else
#define CONFIG_TARGET_NAME      sun8iw16p1
#endif
...
/*******boot0 support dma for spinor init*******/
#define CONFIG_BOOT0_SUPPORT_DMA

/*******for boot0 loader kernel*******/
/* #define CONFIG_BOOT0_JUMP_KERNEL */
...
#define OPTEE_BASE                           (0x419e4000)
#define SCP_DRAM_BASE                      (0x419fb000)
#define SCP_DRAM_SIZE                      (0x4000)
#define SCP_CODE_DRAM_OFFSET		     (0x1C000)

/*fdt base*/
#ifdef CONFIG_SUNXI_FDT_ADDR
#undef CONFIG_SUNXI_FDT_ADDR
#define CONFIG_SUNXI_FDT_ADDR            (CONFIG_SYS_SDRAM_BASE+0x02000000)
#endif
...
#define UBOOT_START_SECTOR_IN_SPINOR        (64*1024/512)
